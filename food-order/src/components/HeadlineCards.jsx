    ...
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
        ...
        <div className='rounded-xl relative'>
            ...
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                <p className='font-bold text-2x1 px-2 pt-4'>Sun's Out,Bogo's Out</p>
        ...
        <div className='rounded-xl relative'>
            {/*Overlay*/}
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                <p className='font-bold text-2x1 px-2 pt-4'>New Best Resturants</p>
        ...
        <div className='rounded-xl relative'>
            {/*Overlay*/}
            <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
                <p className='font-bold text-2x1 px-2 pt-4'>We Delivery Deserts Too</p>
